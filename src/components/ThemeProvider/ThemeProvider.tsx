import { FC, PropsWithChildren, createContext, useState, useMemo, useCallback, useEffect, useLayoutEffect } from 'react';
...
const ThemeProvider: FC<PropsWithChildren<ThemeProviderProps>> = ({ children, themeStorage, useUserAgentTheming }) => {
    ...
    return (
        <ThemeContext.Provider value={providerValue}>
            <div id={ROOT_ID} style={useUserAgentTheming ? { colorScheme: theme } : undefined}>
                {children}
            </div>
