export const supplies = {
  ...
  'supply.warehouse': 'Склад',
  'supply.warehouse.description': 'Оберіть склад',
  'supply.warehouse.error.required': "Склад є обов'язковим",
  'supply.product.name': 'Назва',
  ...
  'supply.product.totalCost.error.required':
    "Загальна вартість товару є обов'язковою",
  'supply.product.totalCostProducts': 'Загальна вартість товарів',
  'supply.product.unit': 'Одиниця зберігання',
  'supply.product.unit.error.required':
    "Одиниця зберігання товару є обов'язковою",
  ...
  'supply.products.maxNumber':
    'Максимальна кількість товарів в одному постачанні: {value}',
  'supply.productDuplication':
    'У постачанні знайдено товари, які зустрічаються більше одного разу:',
  ...
  'supply.creating': 'Створення постачання "{supplyName}"',
  'supply.creating.error':
    'Під час створення постачання "{supplyName}" сталася помилка',
  'supply.created': 'Постачання "{supplyName}" було успішно створено',
};
