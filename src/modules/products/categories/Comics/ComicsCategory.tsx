...
const schema = yup
  ...
  .shape({
    ...
    publishingHouse: yup
      .string()
      .required('attributes.publishingHouse.error.required'),
...
const ComicsCategory: FC<CategoryProps<ComicsProduct>> = ({
  ...
  const getTranslatedDropdownValue = (
    item:
      | null
      | string
      | string[]
  ...
  const handleFormSubmit = async (
    values: ComicsCategoryFormValues,
  ): Promise<void> => {
